...
flags.DEFINE_integer('clients_per_round', 20,
...
# Data configuration
flags.DEFINE_string('tfrecords_dir', "/home/work/seongbin/FEMNIST/tfrecords", 'Path to FLAIR tfrecords.')
flags.DEFINE_integer('image_height', 32, 'Height of input image.')
flags.DEFINE_integer('image_width', 32, 'Width of input image.')
